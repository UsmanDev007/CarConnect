  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        // Side logic
        side === "left" && "inset-y-0 left-0 h-full w-3/4 border-r border-slate-800 sm:max-w-sm data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
        side === "right" && "inset-y-0 right-0 h-full w-3/4 border-l border-slate-800 sm:max-w-sm data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
        className
      )}
      {...props}
    >
