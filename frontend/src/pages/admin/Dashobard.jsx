      ...
      <main className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat) => (
            <div
              key={stat.id}
              className="relative overflow-hidden bg-slate-900/40 border border-white/5 p-7 rounded-[2.5rem] hover:border-blue-500/30 transition-all duration-500 group"
            >
              <div
              ...
              <div className="relative z-10">
                ...
                <div className="text-4xl font-black italic tracking-tighter mb-1 group-hover:text-blue-400 transition-colors">
                  {stat.value}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-slate-900/20 border border-white/5 rounded-[3rem] p-8 min-h-[450px]">
            <div className="flex items-center justify-between mb-8 px-4">
              <h4 className="text-slate-400 font-black uppercase italic tracking-[0.2em] text-sm">
                Platform Distribution
              </h4>
              <div className="flex gap-4 text-[10px] font-bold uppercase text-slate-500">
                <span className="flex items-center gap-1">
                  <div className="w-2 h-2 bg-blue-500 rounded-full" /> Value
                </span>
              </div>
            </div>
          ...
          <div className="bg-slate-900/20 border border-white/5 rounded-[3rem] p-10 flex flex-col items-center justify-center min-h-[450px] group border-dashed hover:border-solid hover:border-white/10 transition-all">
            ...
            <div className="mt-8 space-y-3 w-full">
              <button className="w-full py-4 bg-white/5 border border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all">
                Add New Listing
              </button>
              <button className="w-full py-4 bg-white/5 border border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-black transition-all">
                Export Report
              </button>
            </div>
          </div>
